...
# 筛除多行的label.txt
input_label_dir = r'D:\Downloads\dataset1\train\labels'
output_label_dir = r'D:\Downloads\dataset1\output\label'
...
for label_name in label_name_list:
    ...
    if len(lines) > 1:
        print(lines[1])
        # shutil.copy(label_file_name, './data/math/mult-line_label/' + label_name)
        continue
